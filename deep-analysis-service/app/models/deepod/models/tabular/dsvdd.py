...
class DeepSVDD(BaseDeepAD):
    ...
    def load(cls, path, device=None):
        ...
        network_params = {
            ...
            'n_hidden': model_dict['hidden_dims'],
            'n_output': model_dict['rep_dim'],
            'activation': model_dict['act'],
            'bias': model_dict['bias']
        }
        model.net = MLPnet(**network_params).to(device)
        model.net.load_state_dict(model_dict['net_state_dict'])
        
        # 设置中心点
        model.c = model_dict['c']
        model.n_features = model_dict['n_features']
