...
from deepod.core.networks.base_networks import MLPnet, MlpAE, GRUNet, LSTMNet, ConvSeqEncoder,\
...
class DeepSAD(BaseDeepAD):
    ...
    def __init__(self, epochs=100, batch_size=64, lr=1e-3,
                 ...
                 verbose=2, random_state=42, model_name='DeepSAD', c = None):
    ...
    def training_prepare(self, X, y):
        ...
        criterion = DSADLoss(c=self.c, eta1=50, eta2=50)

        if self.verbose >= 2:
            print(net)

        return train_loader, net, criterion, self.c
...
class DSADLoss(torch.nn.Module):
    ...
    def __init__(self, c, eta1, eta2 , eps=1e-6, reduction='mean'):
